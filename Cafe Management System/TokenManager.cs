...
namespace Cafe_Management_System
{
    ...
    {
        public static string Secret = "eU$47oGytpQbT2L@m9L!gNcRfpoHzEa1wKsYvt3lTpAqR8jCz";
        ...
        public static ClaimsPrincipal GetPrincipal(string token)
        {
            try
            {
                ...
                JwtSecurityToken jwtToken = (JwtSecurityToken)tokenHanler.ReadToken(token);
                if (jwtToken == null)
                {
                    return null;
                }
                ...
                ClaimsPrincipal principal = tokenHanler.ValidateToken(token, parameters, out securityToken);
                return principal;
            }
            catch (Exception e)
            {
